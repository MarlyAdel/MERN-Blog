 ...
 * @access public
 ...
 const registerUserCtrl = asyncHandler(async (req,res) => { 
    ...
    // 5- Save it to DB
     ...
     //TODO [Done] : Sending Email (verify account)
     //1_ Creating new verificationToken & save it to DB
     ...
     //3_ Putting the link into an html template
     const htmlTemplate = 
     `<div>
        <p>Click on the link below to verify your email</p>
        <a href="${link}">verify</a>
      </div> `
     //4_ Sending Email to the user
  ...
  * @access public
  ...
  const loginUserCtrl = asyncHandler (async (req,res) => {
    ...
    //TODO [Done] : Sending Email (verify account if not verified)
